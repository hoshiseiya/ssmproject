...
<script type="text/javascript">
	...
	function showRemarkList() {
		$.ajax({
			url: "contacts/getRemarkListById.do",
			data: {
				"contactsId": "${c.id}"
			},
			dataType: "json",
			...
			success: function (data) {
                ...
                * */
				...
				$.each(data, function (i, n) {
					...
					html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.fullname}</b> <small id="s' + n.id + '"style="color: gray;"> ' + (n.editFlag == 0 ? n.createTime : n.editTime) + ' 由' + (n.editFlag == 0 ? n.createBy : n.editBy) + '</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
