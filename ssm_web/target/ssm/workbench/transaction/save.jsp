...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#create-customerName").typeahead({//自动补全插件
                source: function (query, process) {//query是我们输入的数据,process是回调函数
                    $.get(
...
<form action="transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form"
